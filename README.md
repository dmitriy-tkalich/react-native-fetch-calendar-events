...
*It's a fork of [React-Native-Calendar-Events](https://github.com/wmcmahan/react-native-calendar-events) with support for fetching calendar events on Android. As soon as code will be refactored, going to remove this repo and send a PR to "react-native-calendar-events".*
...
## fetchAllEvents
Fetch all calendar events from EventStore (iOS) and CalendarContract (Android).
